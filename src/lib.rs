...
pub struct Invariant {
    ...
    tmp: Variable<TmpStruct>,
    tmp_address: Variable<Address>,
    tmp_percentage: Variable<Percentage>,
}
...
impl Entrypoints for Invariant {
    ...
    pub fn init(&mut self, fee: U128) {
        ...
        self.tmp.set(tmp_struct);
        self.tmp_address
            .set(Address::Account(AccountHash::new([0x02; 32])));
        self.tmp_percentage.set(Percentage::default());
    }
