...
fn test_add_multiple_fee_tiers() {
    ...
    invariant
        .add_fee_tier(first_fee_tier.fee.v, first_fee_tier.tick_spacing)
        .unwrap();
    invariant
        .add_fee_tier(second_fee_tier.fee.v, second_fee_tier.tick_spacing)
        .unwrap();
    invariant
        .add_fee_tier(third_fee_tier.fee.v, third_fee_tier.tick_spacing)
        .unwrap();
...
fn test_add_existing_fee_tier() {
    ...
    let result = invariant.add_fee_tier(first_fee_tier.fee.v, first_fee_tier.tick_spacing);
...
fn test_add_fee_tier_not_admin() {
    ...
    let result = invariant.add_fee_tier(fee_tier.fee.v, fee_tier.tick_spacing);
